...
func dumpRequestHandler(req *http.Request, ctx *goproxy.ProxyCtx) (*http.Request, *http.Response) {
	log.Printf(`{"requestURL": %q}`, req.URL)
...
func run() error {
	...
	proxy.OnRequest().DoFunc(dumpRequestHandler)
