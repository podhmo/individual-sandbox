...
print(main(["-h", "--fn", "f"]))
print(main(["--verbose"]))
print(main(["--verbose", "--fn", "f"]))
print(main(["--verbose", "--fn", "g"]))
print(main(["--verbose", "--fn", "f", "--name", "foo", "--y", "10"]))
print(main(["--verbose", "--fn", "g", "--name", "foo", "--y", "10"]))
print(main(["--verbose", "-h"]))
print(main(["--verbose", "-h", "--fn", "g", "--name", "foo"]))
