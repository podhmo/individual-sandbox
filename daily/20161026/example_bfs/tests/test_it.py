...
class Tests(unittest.TestCase):
    def _makeOne(self, items=None):
        from bbfs import BidirectionalBFS
        return BidirectionalBFS(items or [])
    ...
    def test_x2_to_y1__shortest(self):
        ...
        target = self._makeOne([
            ...
            ("string", "A0"), ("A0", "A1"), ("A1", "A2"),
            ("string", "B0"), ("B0", "B1"), ("B1", "B2"),
            ("string", "C0"), ("C1", "Y1"), ("C1", "C2"),
            ("string", "D0"), ("D0", "D1"), ("D1", "D2"),
            ("string", "Y0"), ("Y0", "Y1"), ("Y1", "Y2"),
        ])
        actual = target.resolve(src="X2", dst="Y2")
        expected = [['coerce', 'X2', 'X1'], ['coerce', 'X1', 'X0'], ['coerce', 'X0', 'string'], ['coerce', 'string', 'Y0'], ['coerce', 'Y0', 'Y1'], ['coerce', 'Y1', 'Y2']]
        self.assertEqual(expected, actual)
