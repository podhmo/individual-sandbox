...
from prestring.codeobject import CodeObjectModule, Symbol
...
def build(
    co: CodeObjectModule, name: str, c: Symbol, provider: Provider[T_co]
) -> Symbol:
    ...
    if n == 1:
        ...
        return co.let(name, f"{provider.__name__}({c})")
    elif n == 2:
