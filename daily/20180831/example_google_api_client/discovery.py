...
def createMethod(methodName, methodDesc, rootDesc, schema):
  ...
  """
    ...
    (pathUrl, httpMethod, methodId, accept, maxSize,
     mediaPathUrl) = _fix_up_method_description(methodDesc, rootDesc, schema)
    ...
    def _add_next_methods(self, resourceDesc, schema):
        ...
        for methodName, methodDesc in six.iteritems(resourceDesc['methods']):
            ...
            fixedMethodName, method = createNextMethod(
                methodName + '_next', pageTokenName, nextPageTokenName, isPageTokenParameter
            )
            self._set_dynamic_attr(fixedMethodName, method.__get__(self, self.__class__))
