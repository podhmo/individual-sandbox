...
```yaml
paths:
  /podhmo/pod.hatenablog.com/edit:
    get:
      description: ''
      parameters:
      - example: '1'
      ...
      - example: 3210bc64477a2978e5c57fbe3b18f45564097c1e
        in: cookie
        name: rk
      - example: 75925b1cc59fbafd290de320f15accb14656d458
        in: cookie
        name: sk
      responses:
        200:
    ...
    post:
      ...
      - example: 3210bc64477a2978e5c57fbe3b18f45564097c1e
        in: cookie
        name: rk
      - example: 646e745905c03c8c111d0c950d19186edbeea764
        in: cookie
        name: sk
      responses:
        200:
...
paths:
  /embed:
    get:
      description: ''
      parameters:
      - example: 'https://marmelab.com/blog/2016/02/29/auto-documented-makefile.html'
        in: query
        name: url
      - example: '1'
        in: header
  ...
  /entries.json:
    get:
      ...
      - example: '1'
        in: query
        name: no_comments
      - example: 'https://pod.hatenablog.com/entry/2019/04/10/130101'
        in: query
        name: uri
      - example: ''
        in: query
        name: ''
      - example: Ten.JSONP.callback
        in: query
        name: callback
      - example: ''
        in: query
        name: 'Sat Apr 20 2019 23:13:44 GMT+0900 (Japan Standard Time)'
      - example: $1$w1j8R1lz$BcCPV8gLDAR113FUnpdKY.
        in: cookie
        name: b
      - example: f0fdbfbc-f277-4862-9bda-3ccd7f92c46e
