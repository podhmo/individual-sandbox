...
type Person struct {
	...
	Skils     map[string]string  `json:"skils"`
	Children  map[string]Person  `json:"children"`
	Children2 map[string]*Person `json:"children2"`
	Children3 *map[string]Person `json:"children3"`
}
...
func (p *Person) UnmarshalJSON(b []byte) error {
	...
	var inner struct {
		...
		Skils     *map[string]string `json:"skils"`     // required
...
func main() {
	b := bytes.NewBufferString(`{"name": "foo","skils": {"foo": "xx"}, "children": {"me": {}}, "children2": {}}`)
