...
questions = [
    inquirer.Text(
        'user', message='Please enter your github username', validate=lambda _, x: x != '.'
    ),
    ...
    inquirer.Text(
        'organization',
        message=
        'If this is a repo from a organization please enter the organization name, if not just leave this blank'
    ),
    inquirer.Confirm(
        'correct',
