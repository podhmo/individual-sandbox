...
func Run(dbmap *gorp.DbMap) error {
	...
	// insert rows - auto increment PKs will be set properly after the inser
...
func NewDbMap(dburl string) (*gorp.DbMap, error) {
