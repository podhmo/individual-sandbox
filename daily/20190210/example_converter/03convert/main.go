...
func (f *fixer) FixPerson(src *Person, dst *PersonResponse) error {
	...
	return f.bindPerson(dst, nickname(xNickname), iconURL(f.DefaultAvatorURL))
}
...
func (f *fixer) bindPerson(dst *PersonResponse, nickname nickname, iconURL iconURL) error {
